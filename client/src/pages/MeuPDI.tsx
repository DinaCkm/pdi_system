            ...
            <Card key={pdi.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  {/* Indicação de Validação pelo Líder */}
                  {pdi.validadoEm ? (
                    ...
                    <div className="flex items-center gap-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-semibold text-amber-700">Aguardando Aprovação do Líder</p>
                        <p className="text-xs text-amber-600">
                          Seu PDI ainda não foi validado pelo líder
                        </p>
                      </div>
                    </div>
                  )}
            ...
            <div className="space-y-6 py-4">
              ...
              {selectedPDI.relatorioAnalise && (
                <div className="space-y-2">
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-md p-3 max-h-[200px] overflow-y-auto">
