...
ALTER TABLE `notifications` MODIFY COLUMN `lida` tinyint NOT NULL;--> statement-breakpoint
ALTER TABLE `notifications` MODIFY COLUMN `lida` tinyint NOT NULL DEFAULT 0;--> statement-breakpoint
