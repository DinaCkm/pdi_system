...
## ETAPA 2: Admin Processa Solicitações de Ajuste (IMPLEMENTAÇÃO NECESSÁRIA)

**Problemas Identificados:**
- [ ] Card de solicitação não mostra nome do colaborador
- [ ] Card de solicitação não mostra nome do líder do colaborador
- [ ] Card de solicitação não mostra nome da ação original
- [ ] Modal de detalhes não tem campos editáveis para Admin ajustar
- [ ] Não há botão "Aceitar e Alterar" para Admin aprovar com edições
- [ ] Não há botão "Devolver para Melhorar" para Admin rejeitar com motivo

**Implementação Necessária:**
- [ ] Backend: Atualizar query getPendingAdjustmentRequests para retornar dados do colaborador, líder e ação
- [ ] Frontend: Melhorar card para exibir nome do colaborador, líder e ação original
- [ ] Frontend: Adicionar campos editáveis no modal de detalhes (nome, descrição, prazo)
- [ ] Frontend: Implementar botão "Aceitar e Alterar" com mutation para aprovar
- [ ] Frontend: Implementar botão "Devolver para Melhorar" com campo de motivo
- [ ] Backend: Criar procedure para Admin aceitar e alterar ação (approveAndAdjustmentRequest)
- [ ] Backend: Criar procedure para Admin devolver solicitação com motivo (rejectAdjustmentRequest)
- [ ] Backend: Atualizar status da ação para "aguardando_lider" após Admin aceitar
- [ ] Backend: Criar notificação para colaborador quando solicitação é devolvida
- [ ] Testar fluxo completo com Admin
