...
## Correção do Dashboard Admin - Comentário do Líder (25 JAN 2026)
- [x] Remover aba separada "Com Parecer do Líder"
- [x] Integrar comentário do líder na aba "Solicitações"
- [x] Mostrar comentário do líder junto com os detalhes da solicitação
- [x] Destacar visualmente solicitações que já têm parecer do líder (badge roxo + fundo roxo claro)
